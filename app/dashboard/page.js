  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800">Clinical Trials Dashboard</h1>
      ...
      <ul className="space-y-4">
        {trials.map((trial) => (
          <li key={trial._id} className="bg-white p-4 rounded shadow hover:shadow-md transition-shadow">
